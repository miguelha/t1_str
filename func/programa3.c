...
int main(int argc, char* argv[]){
    ...
    // set priorities
    param_f1.sched_priority = 10;
    param_f2.sched_priority = 20;
    param_f3.sched_priority = 30;
    ...
    // create pthreads
    pthread_create(&thr_f1, &attr_f1, &thread_f1, (void*)thr_f1_in);
    pthread_create(&thr_f2, &attr_f2, &thread_f2, (void*)thr_f2_in);
    pthread_create(&thr_f3, &attr_f3, &thread_f3, (void*)thr_f3_in);
